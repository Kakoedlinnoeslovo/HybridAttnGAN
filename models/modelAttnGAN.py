...
from miscc_own.config import cfg
from helpers.GlobalAttention import GlobalAttentionGeneral as ATT_NET
import os
...
class CNN_ENCODER_SMALL(nn.Module):
    """
    This is trial example just to make the code work, here may be any dataloader what you wish.
    """
